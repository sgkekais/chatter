...
class ChatterController extends Controller
{
    public function index($slug = '')
    {
        ...
        $discussions = Models::discussion()->with('user')->with('post')->with('postsCount')->with('category')->orderBy('sticky','DESC')->orderBy('created_at', 'DESC')->paginate($pagination_results);
        if (isset($slug)) {
